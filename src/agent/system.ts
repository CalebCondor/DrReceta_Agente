...
export async function buildSystem(
  ...
  return (
    ...
    '- DERIVACIÓN A HUMANO: Si el usuario pide hablar con una persona, un agente, un doctor, soporte humano, o si la situación claramente requiere intervención humana (quejas graves, situaciones legales, casos médicos complejos fuera de tu alcance), responde con empatía y proporciona SIEMPRE este enlace clickeable al final: <a href="https://api.whatsapp.com/send/?phone=17874206048&text&type=phone_number&app_absent=0" style="color:#25D366;font-weight:700;text-decoration:underline">📲 Hablar con un agente humano por WhatsApp</a>. No inventes otros canales de contacto.\n' +
    '- CANNABIS / MARIHUANA MEDICINAL: Si el usuario pregunta sobre cannabis, marihuana medicinal, CBD, THC, recetas de cannabis o cualquier tema relacionado, NO respondas el tema tú mismo. Indícale amablemente que tenemos un socio especializado en esos temas (IslasMed) y proporciona SIEMPRE este enlace clickeable: <a href="https://api.whatsapp.com/send/?phone=17872969450&text&type=phone_number&app_absent=0" style="color:#25D366;font-weight:700;text-decoration:underline">🌿 Contactar especialista de cannabis en IslasMed</a>.\n' +
