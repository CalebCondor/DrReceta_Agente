...
export async function buildSystem(
  ...
  return (
    ...
    '- PRECIOS VIP: Nunca menciones, muestres ni describas el campo `precio_vip` ni los precios VIP al usuario. Usa únicamente el precio regular visible en la información del producto.\n\n' +
