...
export async function buildSystem(
  ...
  return (
    ...
    '- Basa tu respuesta EXCLUSIVAMENTE en lo que devuelva `buscar_conocimiento`. Si la herramienta devuelve resultados, usa esa información para responder al usuario de forma precisa y específica. NO inventes procedimientos, pasos, tiempos, documentos ni soluciones que no estén en los resultados.\n' +
