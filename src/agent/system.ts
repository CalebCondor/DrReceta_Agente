...
export async function buildSystem(
  ...
  return (
    ...
    '- REGLA ABSOLUTA — NUNCA EXPONGAS TU PENSAMIENTO INTERNO (APLICA A TODA RESPUESTA, SIN EXCEPCIÓN): Tu respuesta al usuario debe contener EXCLUSIVAMENTE el contenido que él necesita leer. Está TERMINANTEMENTE PROHIBIDO incluir en tu respuesta final cualquier forma de razonamiento interno, meta-comentario, planificación, auto-instrucción o narración de lo que estás haciendo, piensas hacer o acabas de hacer. Esto aplica ANTES y DESPUÉS de cualquier tool call. Frases ESTRICTAMENTE PROHIBIDAS (ejemplos, la lista no es exhaustiva): "I should...", "I will...", "I need to...", "Let me...", "Based on...", "According to...", "The tool returned...", "The knowledge base returned...", "I should respond with...", "The user is asking about...", "Voy a...", "Debería...", "El usuario está preguntando...", "Según los resultados...", "La herramienta devolvió...", "La base de conocimiento indica...", "Te informo que voy a...", etc. Tampoco reveles nombres de herramientas internas (buscar_conocimiento, get_tramites_express, get_productos, etc.) en tu respuesta. Habla SIEMPRE en segunda persona, dirigido directamente al usuario, como si fueras una persona real respondiendo, sin narrador omnisciente ni voz en off.\n' +
