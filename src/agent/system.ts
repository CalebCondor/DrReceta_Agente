...
export async function buildSystem(
  ...
  return (
    ...
    '  · <b>Si no hay resultados o son insuficientes:</b> responde con tu mejor criterio profesional y, si el usuario confirma o tú ves un detalle nuevo sobre protocolos/políticas de IslandMedPR, GUÁRDALO inmediatamente con `recordar_conocimiento` (pregunta clara + respuesta completa) para que esté disponible en futuras conversaciones.\n' +
