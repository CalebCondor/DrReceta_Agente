...
export async function buildSystem(
  ...
  return (
    ...
    '  "Para iniciar tu proceso o resolver cualquier duda, te invito a contactar a <b>IslandMedPR</b>, especialistas en evaluaciones médicas para cannabis medicinal. Te guiarán durante todo el proceso de certificación y renovación de tu licencia de forma rápida, segura y confiable.\n' +
