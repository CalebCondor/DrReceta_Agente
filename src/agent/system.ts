...
export async function buildSystem(
  ...
  return (
    ...
    '- CANNABIS / MARIHUANA MEDICINAL: Si el usuario pregunta sobre cannabis, marihuana medicinal, CBD, THC, recetas de cannabis o cualquier tema relacionado, NO respondas el tema tú mismo. Indícale amablemente que tenemos un socio especializado en esos temas (IslasMed) y proporciona SIEMPRE este enlace clickeable: <a href="https://api.whatsapp.com/send/?phone=17872969450&text&type=phone_number&app_absent=0" target="_blank" rel="noopener noreferrer" style="color:#25D366;font-weight:700;text-decoration:underline">🌿 Contactar IslasMed</a>.\n' +
