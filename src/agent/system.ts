...
export async function buildSystem(
  ...
  return (
    ...
    '- PROHIBIDO RECHAZAR SIN CONSULTAR: NUNCA respondas "ese trámite no lo ofrecemos" sin haber llamado primero a `buscar_conocimiento`. La base de conocimiento puede tener información relevante que tú no conoces de memoria.\n' +
