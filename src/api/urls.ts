...
export const ORDERS_RESIDENTES_URL =
  'https://islandmedpr.com/apiia/api/residentes/my_orders.php';
...
export const STATUS_GLOBAL_URL =
  'https://islandmedpr.com/apiia/api/status_by_code.php';
