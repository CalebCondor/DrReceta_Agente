...
async function buildSystem(chatId, db) {
    const now = new Date();
    ...
    let userMemoryInfo = '';
    const session = state_1.sessions.get(chatId);
    ...
    return ('Eres un Profesional de la Salud experto en Atención al Paciente para DoctorRecetas.com. ' +
        languageInstruction +
